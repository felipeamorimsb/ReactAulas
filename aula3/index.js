...
app.delete("/usuarios/:id", (req, res) => {
  try {
    ...
    client.query(
      ...
      function (err, result) {
        if (err) {
          return console.log("Erro ao executar a qry de DELETE", err);
        } else {
...
app.post("/usuarios", (req, res) => {
  try {
    ...
    client.query(
      ...
      function (err, result) {
        if (err) {
          return console.log("erro ao executar a qry de INSERT", err);
        }
